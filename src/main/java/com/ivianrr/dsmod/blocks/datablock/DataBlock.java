package com.ivianrr.dsmod.blocks.datablock;
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) 
    	...
    	if (side == state.getValue(FACING)) {
            ...
            // We only count on the server side.
                ...
                TextComponentTranslation component = new TextComponentTranslation("message.dsmod.counter_par", counter);
                component.getStyle().setColor(TextFormatting.GREEN);
                player.sendStatusMessage(component, false);
            }
        }else return false;//reversed check order, you can place blocks more easily if it isnt the counter face
